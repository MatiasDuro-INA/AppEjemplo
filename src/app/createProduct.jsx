...
import { pickImageFromGallery, takePhotoFromGallery } from "../utils/imagePicker";
...
export default function CreateProduct() {
    ...
    const takePhoto = async () => {
        const uri = await takePhotoFromGallery()
        if(uri) setImageUri(uri)
    }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            <Text styles={styles.heading}>Nuevo Producto</Text>
